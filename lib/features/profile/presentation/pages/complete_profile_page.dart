...
import 'package:qatrah/features/profile/presentation/widgets/complete_profile_form_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => getIt<EditProfileBloc>()
        ...
        ..add(GetRegionsEvent()),
      child: Scaffold(
        appBar: QatrahAppBarWidget(title: Text(l10n.completeProfileTitle)),
        body: const AppBackground(
          child: Center(
            child: SingleChildScrollView(
              padding: EdgeInsets.symmetric(horizontal: 8, vertical: 12),
              child: CompleteProfileFormWidget(),
            ),
          ),
        ),
      ),
