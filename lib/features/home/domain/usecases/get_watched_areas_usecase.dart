// lib/features/home/domain/usecases/get_watched_areas_usecase.dart
...
class GetWatchedAreasUseCase {
  GetWatchedAreasUseCase(this._repository);
  final IHomeRepository _repository;

  Future<Either<Failure, List<AreaEntity>>> call() async {
    return _repository.getWatchedAreas();
  }
}
